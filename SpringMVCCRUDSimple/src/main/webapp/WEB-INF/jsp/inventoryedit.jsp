       ...
       <form:form method="POST" action="/SpringMVCCRUDSimple/editsave">    
        ...
        <td></td>    
         ...
         <tr>    
          ...
          <td><small class="brand-error" style="color: red;visibility: hidden;">Field cannot be empty</small></td> 
         </tr>    
         <tr>    
          <td>Price:</td>    
          <td><form:input path="price" id="price"/></td>  
          <td>  <small class="price-error" style="color: red;visibility: hidden;">field cannot be empty or cannot have text inputs</small></td>
         </tr>   
         <tr>    
          <td>Quantity:</td>    
          <td><form:input path="qty" id="qty"/></td> 
          <td>   <small class="qty-error" style="color: red;visibility: hidden;">Field cannot be empty or cannot have text inputs</small></td> 
         </tr>
          <tr>    
          <td>Description:</td>    
          <td><form:input path="description" id="description"/></td>  
          <td> <small class="description-error" style="color: red;visibility: hidden;">Field cannot be empty</small></td>
         </tr>
          <tr>    
          <td>Category:</td>    
          <td><form:input path="category" id="category"/></td>  
          <td>  <small class="category-error" style="color: red;visibility: hidden;">Field cannot be empty</small></td>
         </tr>
          <tr>    
          <td>Brand:</td>    
         ...
         <tr>    
          <td> </td>    
          <td><input type="submit" value="Edit Save" class="editBtn" /></td>    
         </tr>    
        </table>    
       </form:form>    
...
<script>
let inventoryForm = document.querySelector("#form");
...
inventoryForm.addEventListener("submit", e =>{
    ...
    if(productName.trim() ===""){
        ...
        document.querySelector("#productName").classList.add("error");
        document.querySelector(".productName-error").style.visibility = "visible";

    }else {
        document.querySelector("#productName").classList.remove("error");

    }

    if(price.trim() ===""){
        e.preventDefault();
        document.querySelector("#form-container1").classList.add("error");
    ...
    if(qty.trim() ===""){
        ...
        document.querySelector("#qty").classList.add("error");
        document.querySelector(".qty-error").style.visibility = "visible";

    }else {
        document.querySelector("#qty").classList.remove("error");
    ...
    if(description.trim() ===""){
        ...
        document.querySelector(".description-error").style.visibility = "visible";
     ...
     if(brand.trim() ===""){
        e.preventDefault();
        document.querySelector("#form-container5").classList.add("error");
        document.querySelector("#brand").classList.add("error");
        document.querySelector(".brand-error").style.visibility = "visible";

    }else {
        document.querySelector("#brand").classList.remove("error");
    ...
    if(isNaN(qty)){
        ...
        document.querySelector("#qty").classList.remove("error");
        document.querySelector(".qty-error").style.visibility = "hidden";
    }
    if(isNaN(price)){
        e.preventDefault();
