               ...
               <div class="field">
                    ...
                    <div class="two fields">
                        <div class="field" id="form-container">
                           ...
                           <small class="product-error" style="color: red;visibility: hidden;">Field cannot be empty</small>
                        </div>


                        <div class="field" id="form-container1">
                            <label  for="price">Price</label>
                            <input type="text" name="price"  id="price" >

                            <small class="price-error" style="color: red;visibility: hidden;">Field cannot be empty or cannot have text inputs</small>
                        </div>
                    </div>
                </div>
                 <div class="field">
                    ...
                    <div class="two fields">
                        <div class="field" id="form-container2">
                           ...
                           <small class="qty-error" style="color: red;visibility: hidden;">Field cannot be empty or cannot have text inputs</small>
                        ...
                        <div class="field" id="form-container3">
                            ...
                            <small class="description-error" style="color: red;visibility: hidden;">Field cannot be empty</small>
                        </div>
                    </div>
                </div>
                 <div class="field">
                    ...
                    <div class="two fields">
                        ...
                        <div class="field" id="form-container5">
                            <label  for="brand">Brand</label>
                            <input type="text" name="brand"  id="brand" >

                            <small class="brand-error" style="color: red;visibility: hidden;">Field cannot be empty</small>
                        </div>
                    </div>
                </div>
...
inventoryForm.addEventListener("submit", e =>{
    ...
    if(productName.trim() ===""){
        ...
        document.querySelector(".product-error").style.visibility = "visible";
