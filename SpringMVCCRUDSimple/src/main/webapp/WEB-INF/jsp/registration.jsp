...
<head>
 <link href="Semantic-UI-CSS-master/semantic.css" rel="stylesheet" type="text/css">
    ...
    <script src="sSemantic-UI-CSS-master/semantic.min.js"></script>
<style>
 :root {
                ...
                <div class="field">
                    ...
                    <div class="two fields">
                        <div class="field" id="form-container">
                            ...
                            <small class="fullName-error" style="color: red;visibility: hidden;">Cannot be empty</small>
                        </div>
                            ...
                            <input type="date"  name="dateOfBirth" id=dateOfBirth placeholder="Enter Date of birth" >
                             <small class="dateOfBirth-error" style="color: red;visibility: hidden;">Cannot be empty</small>
                            ...
                            <small class="email-error" style="color: red;visibility: hidden;">Cannot be empty</small>
                    ...
                    <div class="two fields">
                        <div class="field" id="form-container3">
                            ...
                            <small class="phone-error" style="color: red;visibility: hidden;">Cannot be empty and cannot have text inputs</small>
                        </div>
                      ...
                      <div class="two fields">
                        <div class="field" id="form-container4">
                            ...
                            <small class="password-error" style="color: red;visibility: hidden;">Cannot be empty</small>
                        </div>
...
registrationForm.addEventListener("submit", e =>{
    ...
    if(fullName.trim() ===""){
        ...
        document.querySelector(".fullName-error").style.visibility = "visible";
    ...
    if(dateOfBirth.trim() ===""){
        ...
        document.querySelector("#dateOfBirth").classList.add("error");
        document.querySelector(".dateOfBirth-error").style.visibility = "visible";

    }else {
        document.querySelector("#dateOfBirth").classList.remove("error");
