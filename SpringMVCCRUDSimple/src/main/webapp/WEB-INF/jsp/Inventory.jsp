   ...
   border-radius:3px;
	...
	<div class="table">
		...
		<div class="table-header">
			...
			<div class="header__item"><a id="wins" class="filter__link filter__link--number" href="#">Product Name</a></div>
			<div class="header__item"><a id="draws" class="filter__link filter__link--number" href="#">Price</a></div>
			<div class="header__item"><a id="losses" class="filter__link filter__link--number" href="#">Quantity</a></div>
			<div class="header__item"><a id="total" class="filter__link filter__link--number" href="#">Description</a></div>
			<div class="header__item"><a id="wins" class="filter__link filter__link--number" href="#">Category</a></div>
			<div class="header__item"><a id="draws" class="filter__link filter__link--number" href="#">Brand</a></div>
		...
		<div class="table-content">	
		  <c:forEach var="inventory" items="${list}"> 
			<div class="table-row">		
				<div class="table-data">${inventory.productId}</div>
				<div class="table-data">${inventory.productName}</div>
				<div class="table-data">${inventory.price}</div>
				<div class="table-data">${inventory.qty}</div>
				<div class="table-data">${inventory.description}</div>
				<div class="table-data">${inventory.category}</div>
				<div class="table-data">${inventory.brand}</div>
				<div class="table-data"><a href="editinventory/${inventory.productId}" class="edit-btn">Edit</a></div>
				<div class="table-data"><a href="deleteinventory/${inventory.productId}" class="delete-btn">Delete</a></div>
			</div>
			  </c:forEach>
			
		</div>	
	</div>
	<a href="inventoryform" class="btn-inventory">Add New Inventory</a>
</div>
